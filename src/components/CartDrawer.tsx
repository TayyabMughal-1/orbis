        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          {resolved.length === 0 ? (
            <div className="flex h-full flex-col items-center justify-center text-center">
              <p className="font-mono text-[12px] uppercase leading-relaxed text-muted">
                Your cart is empty.
              </p>
              <Link
                to={href('/shop')}
              ...
              {resolved.map(({ line, product, variant, unitPrice, lineTotal, stock }, i) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 flex items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        className="font-mono text-[10px] uppercase text-muted underline underline-offset-2 hover:text-ink"
                      >
                        Remove
                      </button>
                    </div>
                  ...
                  <div className="flex-none text-right">
                    <Price amount={lineTotal} className="font-mono text-[13px] text-accent" />
                    {line.quantity > 1 && (
        ...
        {resolved.length > 0 && (
          <div className="border-t border-ink/10 px-5 py-4">
            ...
            <Link
              to={href('/cart')}
              onClick={close}
              className="mt-2 block py-2 text-center font-mono text-[11px] uppercase text-muted hover:text-ink"
            >
              View full cart
            </Link>
          </div>
